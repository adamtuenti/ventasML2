...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<app-header nombre=\"categorias\"></app-header>\r\n<ion-content>\r\n\r\n  <form #form=\"ngForm\" (ngSubmit)=\"crearProducto(form)\">\r\n    <ion-list>\r\n\r\n      <ion-card style=\"margin-top:15px\">\r\n        <ion-item>\r\n          <ion-label>Título </ion-label>\r\n        </ion-item>\r\n        <ion-item>\r\n\r\n          <ion-input required placeholder=\"Ingrese el título del producto\" name=\"titulo\" type='text' ngModel\r\n            maxlength=\"25\"></ion-input>\r\n        </ion-item>\r\n\r\n      </ion-card>\r\n\r\n      <ion-card style=\"margin-top:15px\">\r\n        <ion-item>\r\n          <ion-label>Descripción </ion-label>\r\n        </ion-item>\r\n        <ion-item>\r\n          <ion-textarea required placeholder=\"Ingrese una descripción del producto\" name=\"descripcion\" type='text'\r\n            ngModel maxlength=\"500\" required></ion-textarea>\r\n        </ion-item>\r\n\r\n\r\n\r\n      </ion-card>\r\n\r\n      <ion-card style=\"margin-top:15px\">\r\n        <ion-item>\r\n          <ion-label>Precio </ion-label>\r\n        </ion-item>\r\n        <ion-item>\r\n          <ion-textarea (ionInput)=\"countChange($event)\" required placeholder=\"Ingrese el precio del producto\"\r\n            name=\"precio\" type='number' ngModel maxlength=\"7\" required></ion-textarea>\r\n        </ion-item>\r\n\r\n\r\n\r\n      </ion-card>\r\n\r\n      <ion-card style=\"margin-top:15px\">\r\n        <ion-item>\r\n\r\n          <ion-item>\r\n            <ion-icon name=\"image-outline\"></ion-icon>\r\n            <ion-text color=\"\" style=\"margin-left: 7.5px;\" *ngIf='image==null'>Subir foto</ion-text>\r\n            <ion-text color=\"\" style=\"margin-left: 7.5px;\" *ngIf='image!=null'>Cambiar foto 1</ion-text>\r\n\r\n            <ion-input type='file' accept=\"image/*\" id=\"myFileInput\" name=\"foto1\" (change)=\"readURL($event);\"\r\n              class=\"fileInput\" ngModel required></ion-input>\r\n\r\n          </ion-item>\r\n\r\n          <ion-item slot='end' *ngIf='image!=null'>\r\n            <ion-icon name=\"images-outline\"></ion-icon>\r\n            <ion-text color=\"\" style=\"margin-left: 7.5px;\" *ngIf='image1==null'>Añadir foto</ion-text>\r\n            <ion-text color=\"\" style=\"margin-left: 7.5px;\" *ngIf='image1!=null'>Cambiar foto 2</ion-text>\r\n\r\n            <ion-input type='file' accept=\"image/*\" id=\"myFileInput\" name=\"foto2\" (change)=\"readURL1($event);\"\r\n              class=\"fileInput\" ngModel></ion-input>\r\n\r\n          </ion-item>\r\n\r\n\r\n\r\n\r\n\r\n\r\n        </ion-item>\r\n\r\n      </ion-card>\r\n\r\n      <ion-card style=\"margin-top:15px\" *ngIf='image!=null'>\r\n        <ion-item>\r\n\r\n          <ng-container>\r\n            <ion-img id=\"blah\" [src]=\"image\" alt=\"your image\"\r\n              style=\"margin-top:5px;margin-bottom: 5px;height: 250px;width: 250px;\"></ion-img>\r\n\r\n          </ng-container>\r\n\r\n\r\n\r\n\r\n          <ng-container *ngIf='image1!=null'>\r\n            <ion-img id=\"blah\" [src]=\"image1\" alt=\"your image\"\r\n              style=\"margin-left: 5px;margin-top:5px;margin-bottom: 5px;height: 250px;width: 250px;\"></ion-img>\r\n          </ng-container>\r\n\r\n\r\n\r\n        </ion-item>\r\n\r\n      </ion-card>\r\n\r\n\r\n      <!-- <ion-card style=\"margin-top:15px\">\r\n        <ion-item>\r\n          <ion-label><ion-icon name=\"image-outline\"></ion-icon> <ion-text color=\"\" style=\"margin-left: 7.5px;\">Seleccionar foto</ion-text></ion-label>\r\n        \r\n          <ion-input type='file' accept=\"image/*\" id=\"myFileInput\" name=\"foto\" (change)=\"readURL($event);\" class=\"fileInput\" ngModel required></ion-input>\r\n        </ion-item>\r\n  \r\n      </ion-card> -->\r\n\r\n\r\n    </ion-list>\r\n\r\n    <ion-button style=\"width: 150px;margin:auto;margin-bottom: 8.5px;\" type=\"submit\" [disabled]=\"form.invalid\"\r\n      expand=\"block\">\r\n      Guardar\r\n    </ion-button>\r\n  </form>\r\n\r\n</ion-content>\r\n<style>\r\n  #myFileInput {\r\n    position: absolute;\r\n    opacity: 0;\r\n  }\r\n</style>");
...
let CrearProductoPage = class CrearProductoPage {
    constructor(angularFireStorage, usuarioService, router, alertCtrt, productosService, activateRoute, loadingController) {
        ...
        this.producto = { Titulo: '', Descripcion: '', Vendedor: '', Categoria: '', Visitas: 0, Precio: 0, Visibilidad: true, Foto1: '', Foto2: '', id: '' };
    ...
    guardarCompleto(downloadURL, downloadURL1) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const docRef = firebase__WEBPACK_IMPORTED_MODULE_8__["firestore"]().collection("Productos").doc();
            this.producto.Foto1 = downloadURL;
            this.producto.Foto2 = downloadURL1;
            this.producto.id = docRef.id;
            yield docRef.set(this.producto);
            this.user.Productos = this.user.Productos + 1;
            this.usuarioService.updateUsuario(this.idUser, this.user).then(auth => {
